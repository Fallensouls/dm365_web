  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        path: "edit/:id",
        name: "数据集编辑",
        meta: { title: "数据集编辑", icon: "fa fa-list-alt" },
      ...
      
      {
        path: "view/:id",
        name: "数据集详情",
        meta: { title: "数据集详情", icon: "fa fa-list-alt" },
        component: () => import("@/views/dataset/dataset_viewer"),
        hidden: true
      },
      {
        path: "image/view/:id",
        name: "图像详情",
        meta: { title: "图像详情", icon: "fa fa-list-alt" },
        component: () => import("@/views/dataset/image_viewer"),
        hidden: true
      },
      {
        path: "image/edit/:id",
